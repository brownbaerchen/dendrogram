...
def test_1D_v2_pseudo_parallel(ntasks, res):
    ...
    # local_dendrograms = DistributedDendrogramV2.compute_local_dendrogram_pseudo_parallel(data.numpy(), ntasks)
...
if __name__ == "__main__":
    test_1D_v2_pseudo_parallel(2, 64)
